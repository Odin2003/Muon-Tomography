...
{
  public:
    B4aEventAction(B4RunAction*, MuonTree*);
    virtual ~B4aEventAction();

    virtual void  BeginOfEventAction(const G4Event* event);
    virtual void    EndOfEventAction(const G4Event* event);
    
    void AddCryParticle(SC8Particle aSC8particle);
  ...
  private:
    ...
    MuonTree* fMuonTree;
    SC8edep   edepSc8;
    std::vector<SC8Particle>  vecSC8CryParticle;
...
inline void B4aEventAction::AddCryParticle(SC8Particle aSC8Particle) {
    // std::cout<<"B4aEventAction::AddGenParticle....  adding a primary particle"<<std::endl;
    vecSC8CryParticle.push_back(aSC8Particle);
}
